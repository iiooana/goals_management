...
<div class="grid grid-cols-3 gap-1">
    ...
    <input type="number" name="{{$name}}" {{$attributes}} class="w-full py-0.5 px-2 dark:text-slate-800 rounded-lg col-span-2 bg-bluew-200" @if(isset($label)) title="{{ $label}}" @endif >
    @error($name)
