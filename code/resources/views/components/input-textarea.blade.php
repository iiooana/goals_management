...
<div class="grid grid-cols-3 gap-1">
    ...
    <textarea name="{{$name}}" {{$attributes}} rows="5" class="w-full py-1 px-2 dark:text-slate-800 rounded-lg col-span-2 bg-bluew-200" @if(isset($label)) title="{{ $label}}" @endif></textarea>
    @error($name)
