        ...
        <tbody>
            ...
            <tr :key="subject_{{$item->id}}">
                ...
                <td class="border border-slate-600  dark:border-slate-200 p-2 text-left">
                    ...
                    <a href="/subject/{{$item->id}}/questions" wire:navigate class="text-xs border border-black dark:border-white rounded-lg p-1 hover:font-extrabold"><i class="fa fa-question"></i> Show questions</a>
                </td>
            </tr>
            @endforeach
        </tbody>
